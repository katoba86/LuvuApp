...
class MyGiftsView extends StatefulWidget {
  ...
  MyGiftsView({this.reload,this.customList});
  @override
  _MyGiftsViewState createState() => _MyGiftsViewState();
}

class _MyGiftsViewState extends State<MyGiftsView> {
  ...
  Widget build(BuildContext context) {
    ...
    onModelReady: (model) {
    model.setCustomList(widget.customList);
              ...
              Padding(
                ...
                child: Hero(
                  ...
                  child: Material(
                    ...
                    child: Text(
                      (widget.customList!=null)?widget.customList.name:
                      "Mein Merkzettel",
                          ...
                          return AnimationConfiguration.staggeredList(
                            ...
                            child: SlideAnimation(
                              ...
                              child: FadeInAnimation(
                                child: GestureDetector(onTap:()=>{model.viewGift(index)},child: GiftItem(gift: model.gifts[index] ,onDeleteItem: () => model.deleteGift(index),)),
                              ),
                            ),
                          );
                        },
